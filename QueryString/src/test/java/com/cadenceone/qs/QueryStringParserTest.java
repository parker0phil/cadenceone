...
public class QueryStringParserTest {
    ...
    public void whenConstructedWithMultipleValueQueryStringParameter_thenReturnsParameterListWithMultipleEntries() throws MalformedURLException {
      ...
      @Test
    public void whenConstructedWithEncodedSpaceContainingValueQueryStringParameter_thenReturnsParameterWithSpace() throws MalformedURLException {
        URL url = new URL("http://www.example.com/foo/bar?goo=car%20dar");
        QueryStringParser parser = new QueryStringParser(url);
